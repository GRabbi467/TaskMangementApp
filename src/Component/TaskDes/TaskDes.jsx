...
const TaskDes = () => {
    ...
    return (
        <div className='description'>
            ...
            <form onSubmit={handleSubmit} className='grid justify-items-start gap-4 items-center my-4  p-12 bg-zinc-200 rounded-lg' >
            <input type="text" name='title' placeholder="Title" className=" w-full max-w-xs p-2" required />
